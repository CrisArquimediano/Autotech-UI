...
import AgendaTaller from './AgendaTaller';
...
export default function visualizacionTurnos(){
    return (
        <>
            <Head>
                <title>KarU - Área Técnica</title>
                <meta name='description' content='Compra y venta de vehículos.' />
